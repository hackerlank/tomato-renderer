...
{
	[ContentImporter( ".obj", CacheImportedData = true, DefaultProcessor = "TomatoModelProcessor" )]
	public class ObjImporter : ContentImporter<NodeContent>
	{
		private ContentImporterContext m_importerContext;
		...
		public override NodeContent Import( string filePath, ContentImporterContext context )
		{
			DateTime startTime = DateTime.Now;

			m_importerContext = context;
			...
			try
			{
				...
				context.Logger.LogImportantMessage( " > Imported .obj model. Total {0} seconds elapsed.", elapsedTime.TotalSeconds );
				...
				case "mtllib":
					{
						...
						for( int i = 1 ; i < lineTokens.Length ; i++ )
						{
							...
							// If this .mtl file is changed, model will be rebuilt by Content Pipeline.
							m_importerContext.AddDependency( mtlFileName );

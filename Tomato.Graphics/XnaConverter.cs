...
namespace Tomato.Graphics
{
	...
	{
		public static ObjectMaterialState GetObjectMaterial( Effect xnaEffect )
		{
			BasicEffect basicEffect = xnaEffect as BasicEffect;
			if( basicEffect != null )
			{
				return new ObjectMaterialState
				{
					Emissive = basicEffect.EmissiveColor,
					Diffuse = basicEffect.DiffuseColor,
					Specular = basicEffect.SpecularColor,
					Shineness = basicEffect.SpecularPower
				};
			}

			AlphaTestEffect alphaTestEffect = xnaEffect as AlphaTestEffect;
			if( alphaTestEffect != null )
			{
				return new ObjectMaterialState
				{
					Emissive = Vector3.Zero,
					Diffuse = alphaTestEffect.DiffuseColor,
					Specular = Vector3.Zero,
					Shineness = 0
				};
			}

			DualTextureEffect dualTextureEffect = xnaEffect as DualTextureEffect;
			if( dualTextureEffect != null )
			{
				return new ObjectMaterialState
				{
					Emissive = Vector3.Zero,
					Diffuse = dualTextureEffect.DiffuseColor,
					Specular = Vector3.Zero,
					Shineness = 0
				};
			}

			EnvironmentMapEffect environmentMapEffect = xnaEffect as EnvironmentMapEffect;
			if( environmentMapEffect != null )
			{
				return new ObjectMaterialState 
				{
					Emissive = environmentMapEffect.EmissiveColor,
					Diffuse = environmentMapEffect.DiffuseColor,
					Specular = environmentMapEffect.EnvironmentMapSpecular,
					Shineness = environmentMapEffect.EnvironmentMapAmount
				};
			}

			SkinnedEffect skinnedEffect = xnaEffect as SkinnedEffect;
			if( skinnedEffect != null )
			{
				return new ObjectMaterialState
				{
					Emissive = skinnedEffect.EmissiveColor,
					Diffuse = skinnedEffect.DiffuseColor,
					Specular = skinnedEffect.SpecularColor,
					Shineness = skinnedEffect.SpecularPower
				};
			}

			throw new InvalidCastException( "Unknown type of Effect passed." );
		}

		public static Texture GetDiffuseTexture( Effect xnaEffect )
		{
			BasicEffect basicEffect = xnaEffect as BasicEffect;
			if( basicEffect != null )
			{
			...
			if( alphaTestEffect != null )
			{
				return alphaTestEffect.Texture;
			}

			DualTextureEffect dualTextureEffect = xnaEffect as DualTextureEffect;
			if( dualTextureEffect != null )
			{
				return dualTextureEffect.Texture;
			}

			EnvironmentMapEffect environmentMapEffect = xnaEffect as EnvironmentMapEffect;
			if( environmentMapEffect != null )
			{
				return environmentMapEffect.Texture;
			}

			SkinnedEffect skinnedEffect = xnaEffect as SkinnedEffect;
			if( skinnedEffect != null )
			{
				return skinnedEffect.Texture;
			}
		...
		public static Keys GetKey( KeyboardKeys key )
		{
			switch( key )
			{
				...
				case KeyboardKeys.Control: return Keys.LeftControl;
				case KeyboardKeys.Alt: return Keys.LeftAlt;
				case KeyboardKeys.Shift: return Keys.LeftShift;
		...
		public static KeyboardKeys GetKey( Keys key )
		{
			switch( key )
			{
				...
				case Keys.LeftControl: return KeyboardKeys.Control;
				case Keys.RightControl: return KeyboardKeys.Control;
				case Keys.LeftAlt: return KeyboardKeys.Alt;
				case Keys.RightAlt: return KeyboardKeys.Alt;
				case Keys.LeftShift: return KeyboardKeys.Shift;
				case Keys.RightShift: return KeyboardKeys.Shift;
